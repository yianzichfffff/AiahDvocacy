			...
			<div class="row">
				<div class="col-md-3">
					<div class="footer-section">
						...
						<div class="footer-section-body">
							<p>Aiahdvocacy: A movement of love, kindness, and hope inspired by Aiah Arceta.</p>
					...
					<div class="footer-section">
						...
						<div class="footer-section-body">
							<ul class="list-links">
								...
								<li>
									<a href="sponsoractivities.php">Activities</a>
								</li>
                                <li>
									<a href="sponsorprojects.php">Projects</a>
								</li>
								
								<li>
									<a href="sponsorgallery.php">Gallery</a>
								</li>
								
								<li>
									<a href="sponsorcontact.php">Contact Us</a>
								</li>
				...
				<div class="col-md-3">
					<div class="footer-section">
						...
						<div class="footer-section-body">
							<p><b>Address:</b> 3104 Roxas Drive, Lazareto, Calapan City, Oriental Mindoro</p>
...
<div class="left-text">Copyright &copy; Aiahdvocacy 2025. All Rights Reserved</div>
</div>
        </div>
        </div>
        </div>

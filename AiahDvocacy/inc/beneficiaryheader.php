  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand logo" href="beneficiary.php"><img src="../uploads/logo.png" class="img-responsive" /></a>
      </div>

      <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
          <li><a href="beneficiary.php">Home</a></li>
          <li><a href="aboutben.php">About Us</a></li>
          <li><a href="projben.php">Projects</a></li>
          <li><a href="conben.php">Contact Us</a></li>
<?php if($loggedIn): ?>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">My Profile (<?= htmlspecialchars($username); ?>) <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="beneficiaryprofile.php">View Profile</a></li>

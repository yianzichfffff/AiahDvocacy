...
if (!$activity) {
    echo "<script>alert('Project not found.'); window.location='adminproject.php';</script>";
    exit;
}
  ...
  <div class="container text-center">
    ...
    <form method="POST" style="max-width:700px; margin:auto; text-align:left;">
      ...
      <div style="text-align:center;">
        ...
        <a href="adminactivities.php?project_id=<?php echo $activity['Project_ID']; ?>" class="btn1" style="background-color: gray;">Cancel</a>
      </div>
    </form>
  </div>
</section>

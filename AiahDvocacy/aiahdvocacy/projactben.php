  ...
  <div class="overlay">
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-sm-6">
          <h6 class="breadcrumb"><a href="beneficiary.php">Home</a> / Activities</h6>
        </div>
      </div>
    </div>
  </div>
...
<section id="about-sec">
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3" style="display:flex; justify-content:space-between; align-items:center;">
      ...
      <a href="bencompletedact.php" class="btn1" style="background-color:#ff4c4c; color:white; padding:8px 15px; border-radius:20px; font-weight:bold; text-decoration:none;">View Completed Activities</a>
      <a href="projben.php" class="btn1" style="background-color:#ff4c4c; color:white; padding:8px 15px; border-radius:20px; font-weight:bold; text-decoration:none;">Back</a>
    </div>

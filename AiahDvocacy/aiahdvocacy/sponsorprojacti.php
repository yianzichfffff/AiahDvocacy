...
if (!isset($_GET['project_id'])) {
    echo "<script>alert('No project selected.'); window.location='sponsorproject.php';</script>";
    exit;
}
  ...
  <div class="overlay">
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-sm-6">
          <h6 class="breadcrumb"><a href="sponsorproject.php">Projects</a> / Activities</h6>
        </div>
      </div>
    </div>
  </div>
...
<section id="about-sec">
 ...
 <a href="donatesponsor.php?activity_id=<?= $act['Activity_ID'] ?>" class="btn1">Donate Now</a>

  ...
  <div class="overlay">
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-sm-6">
          <h6 class="breadcrumb"><a href="admin.php">Home</a> / Projects</h6>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="item">
          <div class="sponser-box">
            ...
            <?php if ($activityCount > 0): ?>
              <a href="project_activities.php?project_id=<?php echo $row['Project_ID']; ?>" class="btn1" style="margin-top:10px;">View Activities</a>
            <?php else: ?>
